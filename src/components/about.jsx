...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 sm:py-24 border-b border-slate-200/80 dark:border-white/[0.06] relative bg-slate-50/50 dark:bg-transparent overflow-hidden">
